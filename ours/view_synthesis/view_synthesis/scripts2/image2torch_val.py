...
DatasetInfo = collections.namedtuple(
    'DatasetInfo',
    ['base_path',  'scene_size','frame_size', 'sequence_size']
)
...
if __name__ == '__main__':
    ...
    torch_dataset_path_bias = torch_dataset_path_bias + '/val/'
    if os.path.exists(torch_dataset_path_bias) == False:
        os.mkdir(torch_dataset_path_bias)
    ...
    for g in range(2,5+1):
        ...
        torch_dataset_path = torch_dataset_path_bias + '/'+'observation_' + str(g) + '/'
        ...
        for l in range(dataset_info.scene_size[0],dataset_info.scene_size[1]+1):
            ...
            pt_dir = os.path.join(torch_dataset_path, f'{l-1}.pt')
