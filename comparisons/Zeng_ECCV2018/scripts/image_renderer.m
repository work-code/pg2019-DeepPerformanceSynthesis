...
blender_location = '"C:\Program Files\Blender Foundation\blender-2.79a-windows64\blender.exe"'; % change it to the blender setup directory in your machine
dataset_dir = 'D:\'; % change it to the directory where the model data are uncompressed
output_dir = sprintf('%srendered_images\\',dataset_dir); % this is the default output directory, change it if you hope to output to other location
...
% rendering loop
for num = 1400:1400
    model_location = sprintf('%strain_point_and_color%d_.ply',dataset_dir,num);
