...
parser.add_argument('--train_test', type=str,default='test', required=False,
                    help='Whether to run training or testing. Options are \"train\" or \"test\".')
parser.add_argument('--data_root', default='data\\synthetic_scenes\\test\\striped_shoe_test',required=False,
                    help='Path to directory that holds the object data. See dataio.py for directory structure etc..')
parser.add_argument('--logging_root', default='logging\\test',required=False,
...
print("*" * 100)
print(14245154326555122342342342342353251452)
